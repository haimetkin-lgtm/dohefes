...
// שני מסלולים בשלב זה (MVP): תמ"א 38 וקומבינציה בעין. שניהם חולקים את אותה שרשרת ליבה
// (שטחים -> עלויות -> הכנסות -> מימון -> רווחיות), ונבדלים באופן חישוב תמורת הקרקע וההכנסות.

export type DealType = "tama38" | "kombinatsia";
