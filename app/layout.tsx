...
const TITLE = 'מחולל דוחות אפס למיזמי נדל"ן';
const DESCRIPTION =
  "מחולל דוחות אפס לבדיקת כדאיות כלכלית במיזמי נדל\"ן, כולל פינוי בינוי, תמ\"א 38, קומבינציה, קבוצות רכישה ועירוב שימושים, לצד דוחות מעקב וכלי דירוג דירות.";
...
const KEYWORDS = [
  ...
  "דוח אפס פינוי בינוי",
  "דוח אפס קומבינציה",
  "בדיקת כדאיות כלכלית לפרויקט נדל\"ן",
  "מחשבון כדאיות כלכלית תמ\"א 38",
  "מחשבון רווחיות יזמות נדל\"ן",
  "דוח כדאיות כלכלית להתחדשות עירונית",
  "דוח אפס לליווי בנקאי",
  "עלות בנייה למ\"ר לשכת שמאי המקרקעין",
  "שמאי מקרקעין דוח אפס",
  "מחולל דוחות אפס",
  "דוח אפס לקבוצת רכישה",
  "דוח אפס לפרויקט מעורב שימושים",
  "דוח אפס קומבינצית תמורות",
  "בדיקת רווחיות מגורים מסחר ומשרדים",
  "דוח מעקב תקציבי לפרויקט בנייה",
  "מעקב תקציב מול ביצוע בבנייה",
  "דוח מעקב בנייה לדוגמה",
  "כלי דירוג דירות פינוי בינוי",
  "טבלת ניקוד דירות פינוי בינוי",
  "דוח אפס Excel",
  "דוח אפס PDF",
  "דוח אפס לדוגמה",
];
  ...
  return (
    <html lang="he" dir="rtl">
      ...
      <body className="min-h-screen bg-gray-50">
        ...
        />
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-GKG9BFQ827" strategy="afterInteractive" />
        <Script id="google-analytics" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
          gtag('config', 'G-GKG9BFQ827');`}
        </Script>
      </body>
    </html>
  );
