...
const DESCRIPTION =
  "מחולל דוחות אפס לבדיקת כדאיות והתכנות כלכלית למיזמי נדל\"ן כולל התחדשות עירונית, קומבינציה, קבוצות רכישה ועירוב שימושים לצד כלי עזר נוספים כמו דוחות מעקב וטבלאות דירוג דירות. © כל הזכויות שמורות לחיים אטקין ו/או לבית שמאי® · haimetkin@gmail.com · www.etkin.co.il";
