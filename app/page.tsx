...
const FAQ_ITEMS = [
  ...
  {
    q: "מה כולל דוח האפס העצמאי?",
    a: "הדוח מרכז את נתוני הקרקע והשטחים, תמהיל היחידות, ההכנסות, עלויות הבנייה והעלויות הנלוות, המימון, המסים ומדדי הכדאיות. התוצאה כוללת פירוט ולא רק שורת רווח סופית, כדי לאפשר בדיקה של ההנחות והחישובים.",
  },
  {
    q: "אילו קבצים אפשר להפיק מהדוח?",
    a: "לאחר רכישת דוח אפס עצמאי ניתן לצפות בדוח המלא, להוריד קובץ Excel ולהפיק גרסה להדפסה או לשמירה כ-PDF. גם כלי דירוג הדירות החינמי כולל Excel והדפסה/PDF.",
  },
  {
    q: "האם אפשר לראות דוגמה לפני הרכישה?",
    a: "כן. באתר זמינות דוגמה לדוח אפס, דוגמת תוצר במסלול בהתאמה אישית, דוגמת דירוג דירות ודוגמה נפרדת לדוח מעקב תקציבי מול ביצוע.",
  },
  {
    q: "מה כולל דוח המעקב ומה ההבדל בינו לבין דוח אפס?",
    a: "דוח אפס בוחן את הכדאיות הכלכלית והתכנון התקציבי של הפרויקט. דוח המעקב הוא מוצר המשך נפרד, המשווה במהלך הבנייה בין התקציב לבין הביצוע בפועל לפי שלבים וסעיפים ומציג יתרות וחריגות.",
  },
  {
    q: "איך עובד כלי דירוג הדירות בפינוי בינוי?",
    a: "מגדירים קריטריונים ומשקלים, מזינים את מאפייני הדירות הקיימות והחדשות, והכלי מחשב ציונים מנורמלים ושקופים. התוצאה מסייעת לקבוע סדר בחירה ולהשוות פערי ערך, אך אינה מבצעת שיוך אוטומטי של דירה חדשה לדייר.",
  },
  {
    q: "כיצד מטופלים פרויקט מעורב שימושים וקבוצת רכישה?",
    a: "בפרויקט מעורב שימושים מוצגת רווחיות נפרדת למגורים, למסחר ולמשרדים לצד התוצאה הכוללת. בקבוצת רכישה ניתן לבחון את עלות הקבוצה ואת רווח מארגן הקבוצה, עם שיטות הקצאה מתאימות ליחידות.",
  },
  {
    q: "האם אפשר לשמור את הדוח ולחזור אליו?",
    a: "כן. לכל דוח נוצר קישור ייחודי שמאפשר לחזור אליו מאותו דפדפן או לשמור את הקישור לשימוש בהמשך. חשוב לשמור את הקישור במקום מוגן ולא להעביר אותו למי שאינו מורשה לצפות בדוח.",
  },
  {
    q: "האם המידע שמוזן שמור ופרטי?",
    a: "כל דוח מקבל קישור ייחודי, והקישור עצמו משמש כמפתח הגישה לדוח ללא הרשמה או התחברות. לכן יש לשמור אותו במקום מוגן ולשתף אותו רק עם מי שמורשה לצפות בנתוני הפרויקט.",
  },
];
...
export default function Home() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(SERVICE_JSON_LD).replace(/</g, "\\u003c") }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(FAQ_JSON_LD).replace(/</g, "\\u003c") }} />
